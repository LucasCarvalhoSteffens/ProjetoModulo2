...
CREATE TABLE `avaliacao` (
  ...
  `pesoaluno` float(5,2) DEFAULT NULL,
  `alturaaluno` float(5,2) DEFAULT NULL,
  `medicacao` varchar(45) DEFAULT NULL,
  `cirurgia` varchar(45) DEFAULT NULL,
  `id_aluno` int DEFAULT NULL,
  PRIMARY KEY (`id_avaliacao`),
  KEY `id_aluno` (`id_aluno`),
  CONSTRAINT `avaliacao_ibfk_1` FOREIGN KEY (`id_aluno`) REFERENCES `aluno` (`id_aluno`)
